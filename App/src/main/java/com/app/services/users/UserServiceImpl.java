...
public class UserServiceImpl implements UserService {
    ...
    public GetUserDTO create(PostUserDTO user) {
        try {
            ...
            User newUser = repo.save(modelMapper.map(user, User.class)); // Guarda el nuevo usuario en la base de datos
            return modelMapper.map(newUser, GetUserDTO.class); // Retorna el DTO del nuevo usuario
