...
export default function ConfirmDischargeModal({ setState, user, users, setUsers }) {
  ...
  return (
    ...
    <p onClick={()=>setState(false)} className="absolute top-3 right-5 dark:text-white dark:hover:bg-gray-700 rounded-full py-1 px-3 cursor-pointer">X</p>
      <h2 className="mt-3">Estas seguro de que quieres dar de baja a {user.name}</h2>
