...
import UpdateSerie from "./Modals/UpdateSerie";

export default function SerieToolbar({ serie, setSerie, episodes, setEpisodes }) {
  const [showSerieUpdate,setSerieUpdate] = useState(false)
  ...
  return (
    <>
      ...
      {showSerieUpdate && <UpdateSerie serie={serie} setSerie={setSerie} setState={setSerieUpdate}/>}
      {showAddEpisode && <AddEpisodeModal serie={serie} setState={setShowAddEpisode} setEpisodes={setEpisodes} episodes={episodes}/>}
    </>
  );
}
